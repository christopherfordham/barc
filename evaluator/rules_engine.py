...
def evaluate_oma(crew_role: str, report_utc: datetime, end_utc: datetime, sectors: int, rest_class: int|None, augmented_pilots: int|None, long_sector_over_9h: bool, inflight_rest_minutes: int, rules: Dict[str, Any], base_tz: str):
